                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="text-slate-300 text-sm before:content-['>'] before:text-cyan-400 before:mr-2">
                        Implemented vulnerability Management System and regularly conducted vulnerability assessments on systems, applications, and networks to identify potential risks
                      </li>
                      <li className="text-slate-300 text-sm before:content-['>'] before:text-cyan-400 before:mr-2">
